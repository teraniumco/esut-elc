...
<div style="max-width:560px; margin:0 auto; background:#fff; border-radius:12px; overflow:hidden; border:1px solid #e5e7eb;">
    ...
    {{-- Header --}}
    <div style="background:#0F2557; padding:32px 32px 24px; text-align:center;">
        <p style="color:#C9A84C; font-size:11px; font-weight:700; letter-spacing:2px; text-transform:uppercase; margin:0 0 8px;">ESUT Law Clinic</p>
        <h1 style="color:#fff; font-size:22px; margin:0; font-weight:700;">Enquiry Received</h1>
    </div>
    ...
    <div style="padding:32px;">
        ...
        <div style="background:#f0f4ff; border:2px solid #0F2557; border-radius:10px; padding:20px; text-align:center; margin:0 0 24px;">
            <p style="color:#6b7280; font-size:11px; margin:0 0 6px; text-transform:uppercase; letter-spacing:1px;">Your Reference Code</p>
            <p style="color:#0F2557; font-size:26px; font-weight:800; letter-spacing:4px; margin:0; font-family:monospace;">{{ $enquiry->reference_code }}</p>
        ...
        <div style="text-align:center; margin:0 0 24px;">
            <a href="{{ route('enquiry.track') }}"
               style="display:inline-block; background:#0F2557; color:#fff; text-decoration:none; padding:12px 28px; border-radius:8px; font-weight:700; font-size:13px;">
                Track My Enquiry
            </a>
        </div>
